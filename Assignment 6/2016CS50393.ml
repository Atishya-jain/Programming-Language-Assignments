...
let fact13 = Clf(Fact(Head(Node("edge",[Node("3",[]);Node("4",[])]))));;
let fact14 = Clf(Fact(Head(Node("edge",[Node("4",[]);Node("1",[])]))));;
let rule11 = Clr(Rule(Head(Node("path",[V(Var("x"));V(Var("y"))])), [Body(Node("edge",[V(Var("x"));V(Var("y"))]))]));;
let rule12 = Clr(Rule(Head(Node("path",[V(Var("x"));V(Var("y"))])), [Body(Node("edge",[V(Var("x"));V(Var("z"))]));Body(Node("path",[V(Var("z"));V(Var("y"))]))]));;

let prog1 = [Prog(fact11);Prog(fact12);Prog(fact13); Prog(fact14);Prog(rule11);Prog(rule12)];;
(* let goal11 = [Goal(Node("edge",[Node("1",[]);Node("2",[])]))];;
let goal12 = [Goal(Node("path",[Node("1",[]);Node("3",[])]))];;
let goal13 = [Goal(Node("edge",[Node("1",[]);V(Var("x"))]))];;
 *)
let goal14 = [Goal(Node("path",[V(Var("q"));V(Var("m"))]));Goal(CUT)];;
...
(* print result14;; *)
(* printInStyle (removedubba result14);; *)
(* 
